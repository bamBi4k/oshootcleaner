 ...
 *   adb shell pm grant com.example.oshootcleaner android.permission.WRITE_SECURE_SETTINGS
...
object DevToolsManager {
    ...
    const val GRANT_COMMAND = "adb shell pm grant com.example.oshootcleaner android.permission.WRITE_SECURE_SETTINGS"
